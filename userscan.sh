...
printf "\e[1;91mNo User Found\e[0m\n"
...
printf "\e[1;96m[\e[0m\e[1;77m#\e[0m\e[1;96m] Udemy: \e[0m"

check1=$(curl -s -i "https://$username.https://www.udemy.com/join/signup-popup/?locale=en_US&next=https%3A%2F%2Fwww.udemy.com%2Flogout%2F&response_type=html/login" -H "Accept-Language: en" -L | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)
...
printf "\e[1;92m \e[0m https://%s.udemy.com/login\n" $username

printf "https://%s.https://www.udemy.com/join/signup-popup/?locale=en_US&next=https%3A%2F%2Fwww.udemy.com%2Flogout%2F&response_type=html/logine\n" $username >> $username.txt
